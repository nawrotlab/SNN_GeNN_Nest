...
#                                    Function
# ********************************************************************************
def SimulateIX(params, IX, measurementVar, ID, PathOutput, lock, PathSpikes=None, timeout=None, Queue=None):
    """
    ...
    EI_Network.set_model_build_pipeline([EI_Network.setup_nest, EI_Network.create_populations,
                                         EI_Network.create_stimulation, EI_Network.create_recording_devices,
                                         EI_Network.connect, lambda: EI_Network.set_I_x(I_XE=IX[0][0], I_XI=IX[1][0])])
